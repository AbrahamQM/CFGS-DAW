-- Archivo: bbdd.sql con todas las instrucciones para crear la base de datos tarea ut7
-- He unido todas las instrucciones en un solo archivo para facilitar su ejecución.
-- incluye las diferentes instucciones ddl y sql adjuntos a la tarea.
-- he metido todo en una transacción para que se ejecute todo o nada.
-- de manera que si hay algún error no se quede la base de datos a medias.
-- Inicio de transacción
begin;

-- 1.- Creamos la Base de Datos
create database if not exists valoracion_productos DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Seleccionamos la base de datos "valoracion_productos"
...
create user if not exists usuarioBBDD @'localhost' identified by "secreto";

-- 4.- Le damos permiso en la base de datos "valoracion_productos"
grant all on valoracion_productos.* to usuarioBBDD @'localhost';

-- Tabla votos: almacena los votos que los usuarios dan a los productos.
...
-- Tabla usuarios
-- Insertamos usuarios de prueba en la tabla usuarios
INSERT INTO
